	...
	public class Teleport : MonoBehaviour
	{
            ...
            if (IsEligibleForTeleport(hand))
            {
                ...
                else
                {
                    if (SteamVR.instance.hmd_TrackingSystemName == "holographic")
                        return hand.controller.GetAxis(EVRButtonId.k_EButton_Axis2).y < maxdown && hand.controller.GetAxis(EVRButtonId.k_EButton_Axis2).y > -maxdown;
                    else if (SteamVR.instance.hmd_TrackingSystemName == "oculus")
                        return hand.controller.GetAxis(EVRButtonId.k_EButton_Axis0).y < maxdown && hand.controller.GetAxis(EVRButtonId.k_EButton_Axis0).y > -maxdown;
        ...
        private bool IsTeleportButtonDown(Hand hand)
        {
            if (IsEligibleForTeleport(hand))
            {
                ...
                {
                    //Debug.Log(SteamVR.instance.hmd_TrackingSystemName);
                    if (SteamVR.instance.hmd_TrackingSystemName == "holographic")
                        return hand.controller.GetAxis(EVRButtonId.k_EButton_Axis2).y > minup;
                    else if (SteamVR.instance.hmd_TrackingSystemName == "oculus")
                        return hand.controller.GetAxis(EVRButtonId.k_EButton_Axis0).y > minup;
        ...
        private bool WasTeleportButtonPressed(Hand hand)
        {
            if (IsEligibleForTeleport(hand))
            {
                ...
                {
                    if (SteamVR.instance.hmd_TrackingSystemName == "holographic")
                        return hand.controller.GetAxis(EVRButtonId.k_EButton_Axis2).y > 0.5f;
                    else if (SteamVR.instance.hmd_TrackingSystemName == "oculus")
                        return hand.controller.GetAxis(EVRButtonId.k_EButton_Axis0).y > 0.5f;
